    ...
    <!-- /.sidebar -->
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        global $con;
                                        $msg=2;
                                        $query = "select * from issueconfirms where message='$msg'";
                    ...
                    <td><a href='apforequipmentconfirm.php?rqtid=$rid'><span class='btn btn-block btn-success'>Approve</span></a></td>
                    <td><a href='apforequipmentcancel.php?rqtid=$rid'><span class='btn btn-block btn-danger'>Decline</span></a></td>
