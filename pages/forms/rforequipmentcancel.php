...
if (isset($_GET['rqtid'])) {
    ...
    $queryi="insert into issueconfirms(message,iname,iqty,irqty,rdep)values('$msg','$sname','$sqty','$srqty','$sdep')";
    ...
    if ($sbquery) {
        echo"<script>swal('Equipment Request Message', 'Request Cancelled Successfully ... !', 'success');</script>";
        echo "<script>document.location='view_equipment_department_requests.php'</script>";
    }else{
        echo"<script>swal('Equipment Request Message', 'Request Cancelling Failed ... !', 'danger');</script>";
    }
