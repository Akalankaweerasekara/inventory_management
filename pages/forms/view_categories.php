...
<html lang="en">
    <head>
        ...
        <title>INVENTORY MANAGEMENT SYSTEM | View All Categories</title>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($gdd = mysqli_fetch_array($gtdata)) {
                                            $tdname = $gdd['category_name'];
                                            $tdcode = $gdd['category_code'];

                                            echo "<tr>
                    <td>$tdcode</td>
                    <td>$tdname</td>
                    <td><a href='catdelete.php?catid=$tdcode'><span class='btn btn-block btn-danger'>Delete</span></a></td>
                    <td></td>
                    <td></td>
                  </tr>";
                                        }
