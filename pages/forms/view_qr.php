...
<html lang="en">
    <head>
        ...
        <title>INVENTORY MANAGEMENT SYSTEM | View All Serializations</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">View All QR Serializations</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                    ...
                    <td>$tdcode</td>
                    <td>$tdname</td>
                    <td><a href='#'><span class='btn btn-block btn-danger'>Generate</span></a></td>
                    <td></td>
                    <td></td>
                  </tr>";
                                        }
